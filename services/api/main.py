...
from services.api.routers import sync, inventory, player, places, notifications, stats, history, achievements, challenges, collection, suggestions, goals, recap, catalogue, leaderboard, craft, events, trade
