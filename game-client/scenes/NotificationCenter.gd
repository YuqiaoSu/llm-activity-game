...
const _FILTER_VALUES := ["", "item_drop", "level_up", "place_unlock", "achievement_unlock", "challenge_complete"]
...
func _ready() -> void:
	...
	for label: String in ["Item Drop", "Level Up", "Place Unlock", "Achievement", "Challenge"]:
